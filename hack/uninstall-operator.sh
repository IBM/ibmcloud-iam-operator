...
kubectl delete secrets,configmaps -n safe -l app.kubernetes.io/name=ibmcloud-iam-operator

# delete all namespaced resources
kubectl delete ns -l app.kubernetes.io/name=ibmcloud-iam-operator 